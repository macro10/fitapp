...
const AlertDialogFooter = ({
  ...
  <div
    className={cn("flex flex-col-reverse gap-3 sm:flex-row sm:justify-end sm:space-x-2 sm:gap-0", className)}
    {...props} />
)
AlertDialogFooter.displayName = "AlertDialogFooter"

const AlertDialogTitle = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn("text-xl sm:text-2xl font-semibold", className)} {...props} />
))
...
const AlertDialogAction = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    className={cn(
      buttonVariants(),
      "h-14 sm:h-16 px-8 text-lg sm:text-xl w-full",
      className
    )}
    {...props}
  />
...
const AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "h-14 sm:h-16 px-8 text-lg sm:text-xl w-full mt-2 sm:mt-0",
      className
    )}
    {...props}
  />
